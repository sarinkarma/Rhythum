...
public class SearchGenreAdapter extends RecyclerView.Adapter<SearchGenreAdapter.MyHolder> {

    List<Genre> genreList;
    Context context;

    public SearchGenreAdapter(List<Genre> genreList, Context context) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_search_genre, parent, false);
