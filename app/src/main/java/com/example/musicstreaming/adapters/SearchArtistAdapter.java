...
public class SearchArtistAdapter extends RecyclerView.Adapter<SearchArtistAdapter.MyHolder> {

    List<Artist> artistList;
    Context context;

    public SearchArtistAdapter(List<Artist> artistList, Context context) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_search_artist, parent, false);
