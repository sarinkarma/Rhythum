...
public class DashboardArtistAdapter extends RecyclerView.Adapter<DashboardArtistAdapter.MyHolder> {

    List<Artist> artistList;
    Context context;

    public DashboardArtistAdapter(List<Artist> artistList, Context context) {
