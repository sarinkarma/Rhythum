...
public class DashboardSongAdapter extends RecyclerView.Adapter<DashboardSongAdapter.MyHolder> {

    List<Song> songList;
    Context context;

    public DashboardSongAdapter(List<Song> songList, Context context) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_dashboard_hits, parent, false);
