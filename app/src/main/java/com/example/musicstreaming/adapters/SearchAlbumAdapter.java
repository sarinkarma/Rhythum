...
public class SearchAlbumAdapter extends RecyclerView.Adapter<SearchAlbumAdapter.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_search_album, parent, false);
